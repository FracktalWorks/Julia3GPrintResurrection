...
plugin_identifier = "Julia3GPrintResurrection"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_Julia3GPrintResurrection"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Octoprint-Julia3GPrintResurrection"
...
# module
plugin_description = """Filament sensor plugin for Fracktal Works Julia 3G"""
...
plugin_url = "https://github.com/FracktalWorks/Julia3GPrintResurrection"
